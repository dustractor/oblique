...
def strat():
    return data[random.randrange(len(data))].strip()
...
class OBLIQUE_OT_strategy(bpy.types.Operator):
    ...
    resultline0: bpy.props.StringProperty()
    resultline1: bpy.props.StringProperty()
    resultline2: bpy.props.StringProperty()
    resultline3: bpy.props.StringProperty()
    ...
    def invoke(self,context,event):
        ...
        result = strat()
        self.result = result
        lines = textwrap.wrap(result,width=40)
        for n,line in enumerate(lines):
            setattr(self,"resultline%d"%n,line)
...
drawfunc = lambda s,c:s.layout.operator("oblique.strategy")
